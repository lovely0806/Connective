...
export default function NewList({ user }) {
  ...
  useEffect(() => {
    ...
    let coverCh = localStorage.getItem("coverChanged");
    let fileCh = localStorage.getItem("fileChanged");
    ...
    setCoverChanged(coverCh);
    setFileChanged(fileCh);
  }, []);
