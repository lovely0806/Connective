    ...
    <>
      ...
      <div className="xs:block md:hidden bg-[#f5f5f5]">
        <div className="relative w-full mx-auto">
          <div className={`after:absolute after:top-[20px]`}>
            <img
              className="h-48 w-[100%] object-cover relative shadow-md rounded-[12px]  ml-[10px]"
              src="/assets/profile/bg.svg"
            />
            <div
              className="absolute top-[20px] right-[20px] cursor-pointer bg-white/[0.2] rounded-full w-[40px] h-[40px] flex items-center justify-center"
        ...
        <div className="flex flex-row w-[85%] mx-auto mb-[15px]">
          <div className="mx-auto mt-[-40px] z-1 bg-white bg-center rounded-full w-[40px] h-[40px] flex items-center justify-center">
            <Image
              className="bg-center"
