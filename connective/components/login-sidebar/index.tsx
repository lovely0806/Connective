const LoginSidebar = () => {
  return (
    <div className="relative flex justify-center items-end font-[Poppins] z-1 w-full h-[100vh] 2bp:min-w-fit bg-[url('/assets/partnerships.svg')] bg-no-repeat bg-center bg-cover  xs: hidden lg:block">
