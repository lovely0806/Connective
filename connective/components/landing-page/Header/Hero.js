      ...
      <div className="w-[978px] font-[Poppins] text-white flex justify-between">
        <div className="max-w-[432px] h-fit mt-[90px]">
          ...
          <div className="flex items-center gap-4 mx-auto">
            ...
            <a href="https://calendly.com/connective-app/30min?month=2022-11" target="_blank"><div className="w-fit flex items-center gap-2.5 border border-[white] py-2 px-4 rounded-[50px] cursor-pointer hover:bg-white/[.10]">
                <Image
