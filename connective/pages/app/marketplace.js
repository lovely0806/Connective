        ...
        <Layout title="Marketplace">
            <div className="mx-20 h-screen">
                <div className="flex flex-row w-full mb-20 gap-10">
                    <input placeholder="Search for lists here" className="w-full mr-32 outline-none px-5 py-2 border border-black/20 rounded-md focus:outline-blue-200 transition-all hover:outline hover:outline-blue-300"></input>
